...
public class TabMyBucketShare extends Fragment implements BucketAuthorAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setOnItemClickListener(TabMyBucketShare.this);
        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef2 = FirebaseDatabase.getInstance().getReference("MyPage").child(id).child("버킷리스트공유");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MyPage").child(id).child("버킷리스트공유");
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(TabMyBucketShare.this.getActivity(), ShareOtherBucketViewActivity.class);
    ...
    public void onDeleteClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(TabMyBucketShare.this.getActivity(), "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
