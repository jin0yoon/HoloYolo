...
public class TabTrip extends Fragment implements TabAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setOnItemClickListener(TabTrip.this);
        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MyPage").child(id).child("여행");
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(TabTrip.this.getActivity(), BoardViewActivity.class);
