...
public class TabFood extends Fragment implements TabAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setOnItemClickListener(TabFood.this);
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(TabFood.this.getActivity(), BoardViewActivity.class);
