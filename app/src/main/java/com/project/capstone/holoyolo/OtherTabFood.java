...
public class OtherTabFood extends Fragment implements TabAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setOnItemClickListener(OtherTabFood.this);
        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MyPage").child(id1).child("other").child("음식");
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(OtherTabFood.this.getActivity(), BoardViewActivity.class);
