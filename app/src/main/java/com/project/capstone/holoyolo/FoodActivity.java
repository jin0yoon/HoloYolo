...
public class FoodActivity extends AppCompatActivity implements ImageAdapter.OnItemClickListener, NavigationView.OnNavigationItemSelectedListener {
...
//        layoutManager.setReverseLayout(true);
        ...
        mAdapter = new ImageAdapter(FoodActivity.this, mAllUploads);
        mAdapter.setOnItemClickListener(this);
        mRecyclerView.setAdapter(mAdapter);

        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Users").child("음식").child("공개");
        ...
        btnplus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(FoodActivity.this, BoardWritingActivity1.class);
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(FoodActivity.this, BoardViewActivity.class);
