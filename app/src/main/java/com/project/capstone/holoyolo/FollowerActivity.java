...
public class FollowerActivity extends AppCompatActivity implements FollowerAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        followreference = database.getReference("MyPage").child(id).child("팔로워");

        mFollows = new ArrayList<>();

        recyclerView = (RecyclerView) findViewById(R.id.msgLv);

        fAdapter = new FollowerAdapter(mFollows);
        fAdapter.setOnItemClickListener(FollowerActivity.this);
    ...
    public void onWhatEverClick(int position) {
        ...
        if(id.equals(id1)){
            ...
            Intent intent = new Intent(FollowerActivity.this, MypageActivity.class);
            intent.putExtra("nickname", nickname);
            intent.putExtra("id", id);
            startActivity(intent);
        }
        else if (!id1.equals(id)){
            Intent intent = new Intent(FollowerActivity.this, OthersPageActivity.class);
            intent.putExtra("nickname", nickname);
