...
public class ShareBoardViewActivity extends AppCompatActivity implements ReplyAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rAdapter.setOnItemClickListener(ShareBoardViewActivity.this);
        ...
        btnchange.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent1 = new Intent(ShareBoardViewActivity.this, BoardChangeActivity.class);
        ...
        btnproceed.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(ShareBoardViewActivity.this, MapsActivity.class);
        ...
        nicknametextview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(id.equals(id1)){
                    Intent intent = new Intent(ShareBoardViewActivity.this, MypageActivity.class);
                    intent.putExtra("nickname", nicknameoriginal);
                    intent.putExtra("id", id);
                    startActivity(intent);
                }
                else if (!id1.equals(id)){
                    Intent intent = new Intent(ShareBoardViewActivity.this, OthersPageActivity.class);
        ...
        btndelete.setOnClickListener(new View.OnClickListener() { // ImageButton을 Click시 AlertDialog가 생성되도록 아래과 같이 설계
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ShareBoardViewActivity.this); // AlertDialog를 띄울 activity를 argument로 지정해야 한다.
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        {
                            ...
                            imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Toast.makeText(ShareBoardViewActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }

                        ShareBoardViewActivity.this.finish(); // App.의 종료. Activity 생애 주기 참고
                    }
                });
...
//                                Log.e("onLocationChanged", "onLocationChanged");
                                ...
                                if (ActivityCompat.checkSelfPermission(ShareBoardViewActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                                        != PackageManager.PERMISSION_GRANTED
                                        && ActivityCompat.checkSelfPermission(ShareBoardViewActivity.this,
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                for (String name : m_lstProviders) {
                                    if (ActivityCompat.checkSelfPermission(ShareBoardViewActivity.this,
                ...
                uri = Uri.parse("http://maps.google.com/maps?f=d&saddr=35.842010, 127.127217&daddr=" + latitude + "," + longtitude);
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
            ...
            alertDialog.setPositiveButton("허가",
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(ShareBoardViewActivity.this,
    ...
    public void onDeleteClick(int position) {
        ...
        if (!id2.equals(id)) {
            Toast.makeText(ShareBoardViewActivity.this, "You can't delete", Toast.LENGTH_SHORT).show();
        } else if(id2.equals(id)) {
            replyreference.child(mReplys.get(position).key).removeValue();
            Toast.makeText(ShareBoardViewActivity.this, "reply deleted", Toast.LENGTH_SHORT).show();
        }
    }
...
//        super.onDestroy();
//        replyreference.removeEventListener(DBListener);
//    }
...
//        ReplyModel user = mReplys.get(position);
//        //user.nickname =
//    }
}