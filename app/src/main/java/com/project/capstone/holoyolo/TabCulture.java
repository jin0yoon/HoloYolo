...
public class TabCulture extends Fragment implements TabAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setOnItemClickListener(TabCulture.this);
        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MyPage").child(id).child("문화");
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(TabCulture.this.getActivity(), BoardViewActivity.class);
