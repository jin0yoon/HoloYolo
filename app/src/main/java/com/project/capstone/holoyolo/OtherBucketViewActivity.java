...
public class OtherBucketViewActivity extends AppCompatActivity implements ReplyAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rAdapter.setOnItemClickListener(OtherBucketViewActivity.this);
        ...
        btnchange.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent1 = new Intent(OtherBucketViewActivity.this, BucketBoardChangeActivity.class);
        ...
        nicknametextview.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OtherBucketViewActivity.this, OthersPageActivity.class);
        ...
        btndelete.setOnClickListener(new View.OnClickListener() { // ImageButton을 Click시 AlertDialog가 생성되도록 아래과 같이 설계
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(OtherBucketViewActivity.this); // AlertDialog를 띄울 activity를 argument로 지정해야 한다.
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        {
                            ...
                            imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Toast.makeText(OtherBucketViewActivity.this, "Item deleted", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }

                        OtherBucketViewActivity.this.finish(); // App.의 종료. Activity 생애 주기 참고
                    }
                });
    ...
    public void onDeleteClick(int position) {
        ...
        if (!id2.equals(id)) {
            Toast.makeText(OtherBucketViewActivity.this, "삭제할 수 없습니다.", Toast.LENGTH_SHORT).show();
        } else if(id2.equals(id)) {
            replyreference.child(mReplys.get(position).key).removeValue();
            Toast.makeText(OtherBucketViewActivity.this, "댓글이 삭제되었습니다.", Toast.LENGTH_SHORT).show();
        }
    }
