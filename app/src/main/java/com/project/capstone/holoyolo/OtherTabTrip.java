...
public class OtherTabTrip extends Fragment implements TabAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab_trip, container, false);
        ...
        mAdapter.setOnItemClickListener(OtherTabTrip.this);
        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MyPage").child(id1).child("other").child("여행");
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(OtherTabTrip.this.getActivity(), BoardViewActivity.class);
