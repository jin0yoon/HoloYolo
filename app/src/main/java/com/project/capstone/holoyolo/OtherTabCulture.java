...
public class OtherTabCulture extends Fragment implements TabAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.tab_culture, container, false);
        ...
        mAdapter.setOnItemClickListener(OtherTabCulture.this);
        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MyPage").child(id1).child("문화").child("공개");
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(OtherTabCulture.this.getActivity(), OtherBucketViewActivity.class);
