...
public class TabShare extends Fragment implements TabAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setOnItemClickListener(TabShare.this);
        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MyPage").child(id).child("공유");
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(TabShare.this.getActivity(), ShareBoardViewActivity.class);
