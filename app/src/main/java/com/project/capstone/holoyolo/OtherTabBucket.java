...
public class OtherTabBucket extends Fragment implements BucketAuthorAdapter.OnItemClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter.setOnItemClickListener(OtherTabBucket.this);
        mStorage = FirebaseStorage.getInstance();
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("MyPage").child(id1).child("other").child("버킷리스트");
        mDBListener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                //Toast.makeText(Tab1Contacts.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void onItemClick(int position) {
        ...
        Intent intent = new Intent(OtherTabBucket.this.getActivity(), OtherBucketViewActivity.class);
    ...
    public void onDeleteClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(OtherTabBucket.this.getActivity(), "Item deleted", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
